...
import { mockSendToQueueDTO, mockConsumeQueueDTO } from '@/protocols/message-queue'
import { mockConsumeMessage, RabbitMQChannelSpy, RabbitMQConnectionSpy } from '@/infrastructure/message-queue/rabbitmq/mocks'
...
jest.mock('amqplib', () => ({
  connect: (_: string) => { return connection }
}))
...
const makeSut = (): sutTypes => {
  const rabbitMQHost = internet.url()
