...
export type ListAccessProfilesAndExportToXLSXFileRouteProps =
RecoverAccessSessionMiddlewareProps &
ListEntitiesAndExportToFileControllerProps

export const makeListAccessProfilesAndExportToXLSXFileRoute = (
  props: ListAccessProfilesAndExportToXLSXFileRouteProps,
  validRepositoryColumns: string[] = [],
  validRequestColumns: string[] = []
): Router =>
  Router()
    .get('/xlsx/:columns',
      ExpressMiddlewareAdapter(makeRecoverAccessSessionMiddleware(props, [AuthenticationAccessRules.ListAccessProfiles])),
      ...
      ExpressControllerAdapter(makeListEntitiesAndExportToFileController(props, AccessProfileEntity)))
