...
const url = '/authentication/module-access-rule/xlsx'
...
describe('GET /authentication/module-access-rule/xlsx/:columns - List ModuleAccessRules And Export to XLSX File', () => {
  beforeAll((done) => {
