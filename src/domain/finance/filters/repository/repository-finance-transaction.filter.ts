export enum RepositoryFinanceTransactionFilter {
  ...
  DateStr = '"finance_transaction"."date_str"',
  ...
  InvoiceStartDateStr = '"invoice"."start_date_str"',
  InvoiceFinalDateStr = '"invoice"."final_date_str"',
  InvoiceDueDateStr = '"invoice"."due_date_str"',
